...
const Visualize = () => {
    ...
    const handleFileChange = (event) => {
        ...
        if (file) {
            ...
            // You can also process/send the file to backend here
        }
    };
                ...
                <div className="row mb-4 align-items-center">
                    <div className="col-lg-1 col-2 me-2">
                        ...
                        <div className="help-box text-center p-2" onClick={handleFileClick}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-folder-fill mb-1" viewBox="0 0 16 16">
