...
const HomePage = () => {
    ...
    // Navigate to Visualize page and pass role state
    const goToVisualize = (role) => {
        navigate('/visualize', { state: { role } });
    };
                    ...
                    <div className="roles-container">
                        {roles.map((role, index) => (
                            <div className="role-card" key={index}>
                                ...
                                <button className="btn-role" onClick={() => goToVisualize(role.roleKey)}>
                                    {role.link}
                                </button>
                            </div>
                        ))}
